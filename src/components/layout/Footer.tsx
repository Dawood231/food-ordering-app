    ...
    <footer className="bg-gray-950 pt-12">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-6 px-10 lg:px-48">
        <div className="col-span-full lg:col-span-1 lg:block">
          <Link href="/" className='text-primary text-2xl font-josefin'>Desi Food</Link>
          ...
          <div className="mt-6 text-gray-400">
            <ul className="space-y-2">
              <li className="inline-flex space-x-4">
                ...
                <span>20 Graham Rd, Malvern WR14 2HL, pakistan </span>
              </li>
              <li className="inline-flex space-x-4">
                <span><PhoneIcon className={"w-6"} /></span>
                <span>+92 334 311 2920</span>
              </li>
              <li className="inline-flex space-x-4">
                <span><MailIcon className={"w-6"} /></span>
                <span>info@desifood.com</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <p className="mt-4 text-gray-400">Copyright &copy; {new Date().getFullYear()} All rights reserved by Muhammad Dawood</p>
      </div>
    </footer>
  )
}
